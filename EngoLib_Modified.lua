...
-- Create Toggle Button (center top)
...
toggleButton.MouseButton1Click:Connect(function()
    local menu = game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("MainFrame") -- Adjust if named differently
    if menu then
...
local mainFrame = game.Players.LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("MainFrame")
if mainFrame then
    if isMobile() then
    ...
    scrollingFrame.Size = mainFrame.Size
    scrollingFrame.Position = mainFrame.Position
    scrollingFrame.CanvasSize = UDim2.new(0, 0, 2, 0)
    scrollingFrame.ScrollBarThickness = 6
    scrollingFrame.BackgroundTransparency = 1
    scrollingFrame.Parent = mainFrame.Parent
